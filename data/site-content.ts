...
export const heroSlides: HeroSlide[] = [
  {
    ...
    alt: "高端宠物洗护店门头外景，奶油色与鼠尾草绿搭配，通透明亮。",
    title: "门店外景",
    desc: "路过时就能感受到整洁和安心，第一眼印象很重要。",
  },
  {
    src: "/store-lounge-ai.png",
    alt: "宠物店接待等候区，浅木色柜台、温暖灯光与整洁陈列。",
    title: "接待等候区",
    desc: "主人和毛孩子都能先放松下来，再进入洗护流程。",
  },
  {
    src: "/store-grooming-ai.png",
    alt: "宠物店洗护美容区，洗护池、毛巾和护理用品整齐摆放。",
    title: "洗护美容区",
    desc: "分区清晰、器具整洁，整个流程更专业也更放心。",
  },
];

export const heroStats = [
  { value: "3000+", label: "累计服务宠物" },
  { value: "4.9", label: "门店综合评分" },
...
export const features: Feature[] = [
  ...
  },
  {
    icon: "🌿",
    title: "精致护理",
    description: "草本泡泡浴、去浮毛护理、除味管理与护毛素加持，提升毛发顺滑度。",
  },
  {
    icon: "📸",
    title: "离店拍照",
    description: "护理结束后提供清洁留影角，让每次洗护都能带走一张好看的纪念照。",
  },
];
...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    features: ["深层清洁与去浮毛护理", "局部修护与除味管理", "会员折扣优先适用"],
  },
];
...
export const scheduleItems = [
  ...
  { label: "服务范围", value: "猫咪 / 小中大型犬 / 其他异宠" },
];
...
export const galleryCards: GalleryCard[] = [
  {
    ...
    images: [
      ...
      { src: "/gallery-bath-3.png", alt: "两只洗护后的宠物在高端宠物店内呈现柔和蓬松感。" },
    ],
  },
  {
    title: "草本舒缓护毛",
...
export const reviews: Review[] = [
  ...
  {
    quote: "已经是第四次来了，店里会先看当天状态再决定护理节奏，不会一上来就强行快进，这点特别安心。",
    name: "陈女士 · 美短主人",
    avatar: "陈",
  },
  {
    quote: "我家法斗皮肤有点敏感，美容师会提前提醒哪些产品更温和。洗完以后没有刺激反应，毛也特别顺。",
    name: "黄先生 · 法斗主人",
    avatar: "黄",
  },
  {
    quote: "最喜欢他们的沟通方式，不会一直强推项目，但会认真说明哪些护理更适合我家毛孩子，体验很舒服。",
    name: "吴女士 · 泰迪主人",
    avatar: "吴",
  },
];
